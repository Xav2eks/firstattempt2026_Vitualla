      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-indigo-300 text-[10px] font-medium uppercase tracking-wide">
                Welcome, Admin!
              </p>
        ...
        <button
          ...
          className="w-full mt-4 bg-white text-indigo-900 font-bold py-3.5 rounded-2xl text-sm hover:bg-indigo-50 transition-colors flex items-center justify-center gap-2 shadow-lg"
        >
      ...
      <div className="flex-1 min-h-0 overflow-y-auto bg-gray-50">
        <div className="px-4 pt-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <button className="text-indigo-700 text-sm font-semibold hover:underline">
              See all
            </button>
          </div>
          ...
          <div className="space-y-3 pb-4">
            {campaigns.map((c, i) => (
              ...
              >
                {/* Thumbnail */}
                <div
                  className={`w-16 h-16 rounded-xl bg-gradient-to-br ${c.color} flex-shrink-0`}
                />
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-2 mb-1">
                    <span
                      className={`text-[10px] font-black px-2 py-0.5 rounded-full border uppercase tracking-wide ${statusStyles[c.status]}`}
                    >
                      {c.status}
                    </span>
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    <div className="flex-1 bg-gray-100 rounded-full h-1.5">
                      <div
                        className={`h-1.5 rounded-full ${c.pct >= 80 ? "bg-green-500" : c.pct >= 50 ? "bg-indigo-500" : "bg-gray-400"}`}
                        style={{ width: `${c.pct}%` }}
                      />
                    </div>
