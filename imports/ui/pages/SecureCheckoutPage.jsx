...
const paymentMethods = [
  {
    id: "gcash",
    label: "GCash",
    icon: "https://brandlogos.net/wp-content/uploads/2024/01/gcash-logo_brandlogos.net_kiaqh-512x427.png",
  },
  {
    id: "maya",
    label: "Maya",
    icon: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/Maya_logo.svg/1280px-Maya_logo.svg.png",
  },
  {
    id: "card",
      ...
      <div className="px-4 py-4 space-y-4">
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
          ...
          <p className="text-xs text-gray-400 mt-1.5">
            Required for your digital donation receipt.
          </p>
          ...
          <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-100">
            ...
            >
              <div
                className={`w-5 h-5 rounded-full bg-white shadow absolute top-0.5 transition-transform ${anonymous ? "translate-x-6" : "translate-x-0.5"}`}
              />
            </button>
          </div>
        </div>
