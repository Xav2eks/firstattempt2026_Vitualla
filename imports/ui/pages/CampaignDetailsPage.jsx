...
const testimonials = [
  {
    quote:
      "I was a scholar once, and now it's my turn to pay it forward. ADDU gave me the foundation I needed.",
    label: "CLASS OF '98 ALUMNUS",
    color: "bg-blue-50 border-blue-100",
  },
  {
    quote:
      "Small acts of giving can transform lives. Every peso of support means the world to a struggling student.",
  ...
  return (
    <MobileShell noPadBottom>
      <div className="flex flex-col min-h-screen">
        ...
        {/* Scrollable Content — grows to fill space, leaves room for footer */}
        <div className="flex-1 overflow-y-auto px-5 py-5 space-y-6">
          {/* The Story */}
          <div>
            <h2 className="text-lg font-bold text-gray-900 mb-3">The Story</h2>
            <p className="text-sm text-gray-600 leading-relaxed">
              Every year, hundreds of bright and deserving students face the
              risk of dropping out due to financial constraints. The Scholarship
              Fund 2024 aims to provide full tuition coverage for 50 incoming
              freshmen from underprivileged backgrounds in Mindanao. Your
              contribution ensures that the Blue Knight spirit continues to
              soar, breaking cycles of poverty through quality Jesuit education.
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <div key={i} className="bg-brand-50 rounded-2xl p-3 text-center">
                ...
                <p className="font-black text-brand-800 text-lg mt-1">
                  {s.value}
                </p>
              ...
              {testimonials.map((t, i) => (
                <div key={i} className={`${t.color} border rounded-2xl p-4`}>
                  ...
                  <div className="flex items-center gap-2 mt-3">
                    ...
                    <span className="text-[10px] font-bold text-brand-700 tracking-wide">
                      {t.label}
                    </span>
                  </div>
                </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              {[
                {
                  date: "Oct 20, 2024",
                  text: "Campaign reached 75% of its funding goal! Thank you to all 142 donors.",
                },
                {
                  date: "Oct 10, 2024",
                  text: "First batch of scholars identified — 50 students from Davao, Cotabato, and Zamboanga.",
                },
              ].map((u, i) => (
                <div
                  key={i}
        ...
        {/* ✅ Fixed: sticky footer — sits naturally at bottom of flex column, no `fixed` positioning */}
        <div className="flex-shrink-0 bg-white border-t border-gray-200 px-5 pt-4 pb-20">
          <button
          ...
          {/* BottomNav sits naturally below the CTA inside the footer */}
          <BottomNav />
        </div>
      </div>
    </MobileShell>
