...
const drives = [
  {
    title: "Calamity Relief: Davao",
    desc: "Urgent support for flood victims.",
    amounts: ["₱500", "₱1000", "₱2000"],
  },
  {
    title: "Animal Shelter",
    desc: "Urgent support for animals in shelter.",
    amounts: ["₱500", "₱1000"],
  },
];
    ...
    <MobileShell>
      ...
      <div className="bg-brand-800 px-5 pt-6 pb-5">
        ...
        <p className="text-brand-200 text-sm mt-1">
          Empowering the next generation of Ateneans.
        </p>
      </div>
      ...
      <div className="px-4 pt-5 space-y-5">
        ...
        <div>
          ...
          {/* ✅ Fixed: outer button → div */}
          <div
            onClick={() => navigate("/donations/campaign/1")}
            className="w-full rounded-2xl overflow-hidden shadow-md relative cursor-pointer"
          >
              ...
              >
                ...
                <div className="flex flex-wrap gap-1.5 mb-3">
                  {d.amounts.map((a) => (
                    <button
                      key={a}
                      className="px-2.5 py-1 rounded-lg border border-gray-200 text-xs font-medium text-gray-700 hover:border-brand-400 hover:text-brand-700 transition-colors"
                    >
                      {a}
                    </button>
                  ))}
