  ...
  return (
    <MobileShell>
      ...
      <div className="bg-gradient-to-br from-admin-900 to-admin-700 px-4 py-4 flex items-center gap-3">
        ...
        <h1 className="text-white font-bold text-base flex-1">Donation Options & Review</h1>
      </div>
        ...
        <div className="flex items-center gap-2">
          {[1, 2].map(s => (
            <React.Fragment key={s}>
              ...
              {s < 2 && <div className="flex-1 h-0.5 rounded-full bg-admin-400" />}
            </React.Fragment>
          ))}
        </div>
        <div className="flex justify-between mt-1.5">
          <p className="text-xs text-admin-400 font-medium">Campaign Details</p>
          <p className="text-xs text-admin-300 font-semibold">Donation Options & Review</p>
        </div>
      </div>
      ...
      <div className="px-4 py-4 space-y-5">
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
          <p className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-3">Suggested Donation Amounts</p>
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="font-bold text-gray-900 text-sm">Enable monthly donations</p>
              <p className="text-xs text-gray-400 mt-0.5">Donors can choose to give automatically every month</p>
            </div>
            <button
            ...
            >
              <div className={`w-6 h-6 rounded-full bg-white shadow absolute top-0.5 transition-transform ${monthlyEnabled ? 'translate-x-7' : 'translate-x-0.5'}`} />
            </button>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div className="bg-gradient-to-br from-amber-100 to-amber-50 p-5">
              ...
              <div className="bg-white rounded-xl p-3 shadow-sm">
                ...
                <p className="text-xs text-center font-semibold text-gray-500">Campaign Image Preview</p>
              </div>
            </div>
            <div className="p-4">
              <h3 className="font-black text-gray-900 text-base">Scholarship Fund for Batch 2024</h3>
              ...
              <div className="mt-3 flex gap-3">
                {selectedPresets.map(amt => (
                  <span key={amt} className="bg-admin-50 text-admin-700 border border-admin-200 text-xs font-semibold px-3 py-1 rounded-lg">
                    {amt}
                  </span>
                ))}
              </div>
