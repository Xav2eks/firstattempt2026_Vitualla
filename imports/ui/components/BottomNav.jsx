...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full lg:hidden bg-white border-t border-gray-200 shadow-lg z-50">
      {/* Inner container: 
          - max-w-md mx-auto: Keeps buttons centered/grouped on tablets 
      */}
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {active && (
                <span className="absolute bottom-0 left-1/4 right-1/4 h-0.5 bg-brand-700 rounded-t-full" />
              )}
            </button>
          );
        })}
